...
class Config
{
    ...
    public static $d = array(
        ...
        'hpge' => array(
            'U-235' => array('level' => 1, 'name' => 'U-235'),
            'U-238' => array('level' => 1, 'name' => 'U-238'),
            'TH-228' => array('level' => 1, 'name' => 'Th-228'),
            'RA-228' => array('level' => 1, 'name' => 'Ra-228'),
            'RA-226' => array('level' => 1, 'name' => 'Ra-226'),
            'K-40' => array('level' => 1, 'name' => 'K-40'),
            'BE-7' => array('level' => 1, 'name' => 'BE-7'),
            'PB-210' => array('level' => 1, 'name' => 'PB-210'),
            'I-131' => array('level' => 1, 'name' => 'I-131'),
            'CO-60' => array('level' => 1, 'name' => 'CO-60'),
            'CS-137' => array('level' => 1, 'name' => 'CS-137'),
            'CS-134' => array('level' => 1, 'name' => 'CS-134'),
            'EU-152' => array('level' => 1, 'name' => 'EU-152'),
            'AM-241' => array('level' => 1, 'name' => 'AM-241'),
