...
$class("CinderellaDevice", DeviceBase,
{
    ...
    onAttach: function(domNode) {
        ...
        this._dataListView.setHeaders([
            ...
            {'key':'Flow', 'name':"流量(m³)"},
            {'key':'FlowPerHour', 'name':'瞬时流量(m³/h)'},
            {'key':'Pressure', 'name':'气压(Kpa)'},
            {'key':'PressureDiff', 'name':'气流压差(pa)'},
    ...
    filter: function(data) {
        ...
        var d =  this.chartFilterData2(data, currentField, this._chartInterval, this._step);
        return d;
    ...
    createSummaryList: function(domNode) {
        ...
        this._sumListView.setHeaders([
            ...
            {'key':'barcode', 'name':'条码'},
            {'key':'flow', 'name':'累计流量(m³)'},
            {'key':'flowPerHour', 'name':'平均瞬时流量(m³/h)'},
